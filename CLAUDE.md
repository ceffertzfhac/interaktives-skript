...
src/figures/aspekt_zentripetalkreuz.js   aspect figure 1.58 (a_ZP as a vector,
                          ...
                          acceleration. DEFAULT ω₀ = 1.0 rad/s (NOT 0.2 like
                          1.57/1.59): a_ZP is drawn to real scale (ACC_SCALE), and
                          at ω₀=0.2 |a_ZP|=0.06 m/s² → ~1 px (invisible); at 1.0 it
                          is ~23 px, comparable to v (~45 px) — the deviation is
...
src/figures/aspekt_paletten.css   wählbare Vektor-Farbpaletten (CVD): 4 Override-
                          ...
                          .aspekt-figur, … #gc10` setzen alle 18 --kb-*-Tokens (WERT +
