...
- [ ] **P22-1 `loading="lazy"` für alle Kapitelbilder** *(S, Wirkung sehr groß)* —
...
- [ ] **P22-2 Bilder auf Anzeigegröße bringen** *(M, Wirkung groß)* — Zielbreite
...
- [ ] **P22-4 Gegenmessung** *(S)* — nach jeder Stufe dieselbe Messung wiederholen
