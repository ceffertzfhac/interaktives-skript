...
- **Abbildung 1.58** — `src/figures/aspekt_zentripetalkreuz.js` + `.css`
  ...
  1.57; Standard ω₀ = 1,0 (s. Fallstrick #26 — bei 0,2 wäre der maßstäbliche
  \vec a_ZP unsichtbar). Die Geisterkurve legt sich bei ω-Vorzeichenwechsel
