...
- **17 interaktive Aspekt-Figuren** auf fünf Motoren: `kreisbewegung`
  (2D, Abb. 1.38–1.51), `kreis_spiral` (ISO-3D, Abb. 1.57–1.59),
  `grundbegriffe` (2D, Abb. 1.1), `bus_weg_zeit` (Abb. 1.2) und
  `federpendel` (harmonische Schwingung, Abschnitt 3.1.5) — mit Reglern,
...
| `InteraktivesSkript_WIP/src/` | ES-Module: `main.js` + Kern, Seiten, Shell, Druck, `figures/` (5 Motoren + 17 Aspekt-Figuren) |
