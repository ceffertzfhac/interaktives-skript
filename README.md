...
- **17 interaktive Aspekt-Figuren** auf sechs Motoren: `kreisbewegung`
  (2D, Abb. 1.38–1.51), `kreis_spiral` (ISO-3D, Abb. 1.57–1.59),
  `grundbegriffe` (2D, Abb. 1.1), `bus_weg_zeit` (Abb. 1.2) und
  `federpendel` (harmonische Schwingung, Abschnitt 3.1.5) und `freier_fall`
  (freier Fall und senkrechter Wurf; portiert, erste Figur folgt) — mit Reglern,
...
| `InteraktivesSkript_WIP/src/` | ES-Module: `main.js` + Kern, Seiten, Shell, Druck, `figures/` (6 Motoren + 17 Aspekt-Figuren) |
