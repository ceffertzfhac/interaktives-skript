...
- **18 interaktive Aspekt-Figuren** auf sechs Motoren: `kreisbewegung`
  ...
  (freier Fall und senkrechter Wurf, Abb. 1.3) — mit Reglern,
...
| `InteraktivesSkript_WIP/src/` | ES-Module: `main.js` + Kern, Seiten, Shell, Druck, `figures/` (6 Motoren + 18 Aspekt-Figuren) |
